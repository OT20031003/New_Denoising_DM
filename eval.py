...
"""
python eval.py --metric lpips ./outputs/adaptive_timestep ./outputs/jointdiffusion/t=0 ./outputs/jointdiffusion/t=50  ./outputs/jointdiffusion/t=150 ./outputs/jointdiffusion/no_ht=0 
